...
class DocumentSummarizer:
    ...
    def __init__(
        ...
        You are a professional document summarizer. Summarize the following document in a comprehensive manner in at least 5000 words.
        ...
        Remember to be precise and comprehensive, focusing on the most important information.
        ...
        self.map_template = """Summarize this section of the document in a few paragraphs maintaining all key information. 
        MOST IMPORTANT: 
    ...
    def summarize(self, documents: List[Document]) -> Dict[str, Any]:
